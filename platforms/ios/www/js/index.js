            ...
            playAudio(n) {
                const media = new Media(
                    ...
                    (error) => {
                        ...
                        console.error('Audio playback error:', JSON.stringify(error));
                    }
                );
                media.play();
            },
            getAudioFilePath(n) {
                // Replace 'audio_file.ogg' with your actual audio file path
                const p = cordova.file.applicationDirectory + `www/audios/attack${n}.ogg`;
